...
class SupervisorDAL 
{
    ...
    public function getSupervisor($table)
    {     
...
*/
    ...
    public function insertSupervisor($arrEmp, $arrSalary, $arrSuppliers)
    {   
        //insert employee        			   
        $affectedRows = $this->conn->insert('supervisors',$arrEmp);
        
       /* if ($affectedRows > 0) {
            $SupervisorId = $this->conn->getLastInsertId();
    ...
    public function updateSupervisor($supervisorId, $arrEmp, $arrSalary, $arrSuppliers)
    {
        //update employee info
		$this->conn->updateData('supervisors', 'SupervisorID', $employeeId, $arrEmp);
    ...
    public function deleteSupervisor($table, $idName, $idValue)
    {
